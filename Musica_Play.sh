...
mpv --ao=pulse --no-terminal --no-border --no-osd-bar --vo=null --save-position-on-quit=yes --resume-playback --input-ipc-server=/tmp/mpvsocket /roms2/music/playlist.m3u & 
